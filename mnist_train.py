...
class MNISTTrainer(Trainer):
    ...
    def validation_end(self, mean_val_outputs=None):
...
# trainer = MNISTTrainer(env_type="pytorch",
#                 max_epochs=10,
#                 batch_size=124,
#                 device="cuda:0",
#                 val_every=1,
...
trainer.train(model, train_dataset=dataset1, optimizer=optimizer, val_dataset=dataset2)
